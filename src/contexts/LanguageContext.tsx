...
const translations = {
  fr: {
    ...
    'portfolio.project14.title': 'Liquid War',
    'portfolio.project14.short': 'Portage Java 21 du jeu Liquid Wars : armées fluides, algorithme de gradient, multijoueur réseau TCP, 13 design patterns et architecture MVC complète.',
    'portfolio.project14.full': 'Portage complet en Java 21 du célèbre jeu Liquid Wars. Chaque joueur contrôle une armée "fluide" de particules se déplaçant via un algorithme de plus court chemin (gradient). Architecture MVC avec 144 fichiers Java, 13 design patterns (Strategy, Factory, Observer, Command, Decorator…), threads virtuels Java 21 pour le multijoueur réseau TCP, Object Pool et ForkJoinPool pour la performance. 35 fichiers de tests, Javadoc 100%, 21 fichiers de documentation Markdown.',
    'portfolio.project15.title': 'Planificateur de tâches système (C)',
    'portfolio.project15.short': 'Système de planification de tâches inspiré de cron en C : démon, client CLI, communication IPC par tubes nommés (FIFO) et protocole binaire.',
    'portfolio.project15.full': 'Projet système L3 Université Paris Cité. Deux programmes : erraid (démon exécutant les tâches planifiées) et tadmor (client CLI pour créer, lister, consulter et supprimer des tâches). Communication par tubes nommés (FIFO), protocole binaire, persistance sur disque, exécution isolée via setsid. Architecture modulaire avec Makefile et tests automatisés. Démontre la maîtrise des mécanismes IPC et de la programmation système POSIX.',
    'portfolio.project16.title': 'HALTE – Site Vitrine Restaurant',
    'portfolio.project16.short': 'Site vitrine pour le restaurant HALTE (Avicenne) : présentation du concept, menu et contact.',
    'portfolio.project16.full': 'Site web vitrine développé en HTML/CSS pour le restaurant HALTE situé à Avicenne. Présentation du concept de restauration, affichage du menu, informations de contact et localisation. Design épuré et responsive adapté aux mobiles.',
    'portfolio.project17.title': 'Solveur DPLL (OCaml)',
    'portfolio.project17.short': 'Implémentation d\'un solveur DPLL récursif en OCaml pour résoudre des formules SAT en forme normale conjonctive (CNF).',
    'portfolio.project17.full': 'Projet universitaire en OCaml implémentant un solveur DPLL récursif complet. Fonctions clés : simplifie, unitaire, pur et solveur_dpll_rec. Architecture modulaire avec tests unitaires pour chaque fonction, exemples SAT/UNSAT fournis. Documentation détaillée de la méthodologie et des choix d\'implémentation.',
  ...
  en: {
    ...
    'portfolio.project14.title': 'Liquid War',
    'portfolio.project14.short': 'Java 21 port of Liquid Wars: fluid armies, gradient pathfinding, TCP multiplayer, 13 design patterns and full MVC architecture.',
    'portfolio.project14.full': 'Full Java 21 port of the famous Liquid Wars game. Each player controls a "fluid" army of particles moving via a shortest-path gradient algorithm. MVC architecture with 144 Java files, 13 design patterns (Strategy, Factory, Observer, Command, Decorator…), Java 21 virtual threads for TCP multiplayer, Object Pool and ForkJoinPool for performance. 35 test files, 100% Javadoc, 21 Markdown documentation files.',
    'portfolio.project15.title': 'System Task Scheduler (C)',
    'portfolio.project15.short': 'Cron-inspired task scheduling system in C: daemon, CLI client, IPC communication via named pipes (FIFO) and binary protocol.',
    'portfolio.project15.full': 'L3 System project at Université Paris Cité. Two programs: erraid (daemon executing scheduled tasks) and tadmor (CLI client to create, list, view and delete tasks). Communication via named pipes (FIFO), binary protocol, disk persistence, isolated execution via setsid. Modular architecture with Makefile and automated tests. Demonstrates mastery of IPC mechanisms and POSIX system programming.',
    'portfolio.project16.title': 'HALTE – Restaurant Website',
    'portfolio.project16.short': 'Showcase website for the HALTE restaurant (Avicenne): concept presentation, menu and contact info.',
    'portfolio.project16.full': 'Showcase website developed in HTML/CSS for the HALTE restaurant located in Avicenne. Presentation of the restaurant concept, menu display, contact information and location. Clean and responsive design adapted for mobile.',
    'portfolio.project17.title': 'DPLL Solver (OCaml)',
    'portfolio.project17.short': 'Implementation of a recursive DPLL solver in OCaml for solving SAT formulas in conjunctive normal form (CNF).',
    'portfolio.project17.full': 'University project in OCaml implementing a complete recursive DPLL solver. Key functions: simplify, unit, pure and dpll_solver_rec. Modular architecture with unit tests for each function, SAT/UNSAT examples provided. Detailed documentation of methodology and implementation choices.',
